...
console.log(
  chalk.hex('#d7a1ff').italic('     T E R I M A K A S I H  S U D A H\n') +
  chalk.hex('#a78bfa').italic('     P A K E  B A I L E Y S RAFAXMODS ♡\n\n') +
  chalk.hex('#89CFF0').italic('     last updated • 9 Febuari 2026\n') +
